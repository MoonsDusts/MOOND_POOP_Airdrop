...
const AirdropCard = () => {
  ...
  // const address = "0x3ba0d1f75c465921231d36a3e6879faf310c46ea";
  ...
  const airdropped = (airdrop as any)?.[2] === true;
  const airdroppable = (airdrop as any)?.[1] > 0n;
    ...
    <div className="bg-white dark:bg-[#212429] shadow-[#00000003_0_0_1px,#0000000a_0_4px_8px,#0000000a_0_16px_24px,#00000003_0_24px_32px] rounded-[30px] p-4 w-11/12 max-w-[420px] min-w-[320px] relative">
      ...
      {!airdropped && (
        <AirdropInfo
          ...
          value={(airdrop as any)?.[2] === true ? 0n : (airdrop as any)?.[1]}
          icon={
            <Image
              src={MOOND.src}
              width={MOOND.width}
      ...
      {airdropped && (
        <AirdropInfo
          ...
          value={(airdrop as any)?.[2] === true ? (airdrop as any)?.[1] : 0n}
          symbol="MOOND"
          icon={
            <>
              <Image
